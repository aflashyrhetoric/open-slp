...
import { LuHandHelping, LuHeart } from 'react-icons/lu';
                    ...
                    <main className="grid12 mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-12 lg:max-w-4xl lg:px-8 lg:py-16 xl:max-w-6xl">
                        <div className={`cs-12 w-full`}>
                            <div className="font-lora mx-auto prose prose-sm sm:prose-base lg:prose-lg xl:prose-xl 2xl:prose-2xl dark:prose-invert">
                                ...
                                {/*<h2 className={`tac fade-in`}>Founding Team</h2>*/}
                                <div className={`grid12 gap-5 font-sans`}>
                                    ...
                                    <div className={`cs-12 fade-in md:cs-6`}>
                                        <figure>
                                            ...
                                            <figcaption>
                                                ...
                                                years of experience, currently working as a founder and engineer at{" "}
                                                <a
                                                    href="https://plosive.app"
                                                    target={'_blank'}
                                                >
                                                    Plosive
                                                </a>, a website built for SLPs to more easily handle their caseloads, paperwork, schedule and more. In the past, I created an online study group with over 30 members from all over the world and helped to facilitate discussion and growth, even creating dedicated video content and courses. I'm also a moderator over at the /r/webdev subreddit, which at time of writing has over 3.2M members.
                                                <br/>
                                                <br/>
                                                I'm excited and humbled to offer up both my technical experience and my experience building online communities to the SLP community.
                                                <br/>
                                                <br/>
                                                Previously, I worked at Homelight, a real estate technology company, and Nulab, a start-up building professional collaborative online software.
                                    ...
                                    <div className={`cs-12 fade-in md:cs-6`}>
                                        <figure>
                                            ...
                                            <figcaption>
                                                <span className="font-bold">
                                                    OpenSLP / Product Oversight
                                                </span>{' '}
                                                <br />I am a Korean-English
                                                Bilingual Speech Language
                                                Pathologist, licensed in New
                                                York since 2019. I'm currently
                                                working at the DoE to provide
                                                bilingual speech-language
                                                services. I also consult as a
                                                Product Advisor for Plosive, an
                                                online productivity platform for
                                                SLPs. <br/><br/>Previously, I’ve worked at
                                                public charter schools in
                                                Harlem, adapting quickly to
                                                manage caseloads of upwards to
                                                65+ students and strategically
                                                leveraging available resources.
                                                I’ve also worked with patients
                                                at various skilled nursing
                                ...
                                <Alert>
                                    <LuHandHelping />
                                    <AlertTitle className={`text-base`}>Interested?</AlertTitle>
                                    <AlertDescription>
