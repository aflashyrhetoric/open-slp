...
export function AnimatedBeamMultipleOutputDemo({
    ...
    return (
        <div
            className={cn(
                'relative flex h-[250px] w-full items-center justify-center overflow-hidden p-10',
                className,
            )}
            ref={containerRef}
        >
            <div className="flex size-full max-w-[400px] flex-row items-stretch justify-between gap-0">
                <div className="flex flex-col justify-center gap-2">
                    <Circle ref={div1Ref}>
                        {/*<Icons.googleDrive />*/}
                        <img src={circleImages[1]} />
                    </Circle>
